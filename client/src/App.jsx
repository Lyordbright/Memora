...
export default function App() {
  return (
    <Routes>
      ...
      <Route
        path="/decks/:deckId"
        element={protect(<DeckView />)}
      />

      <Route
        path="/study"
        element={protect(<StudySession />)}
      />
      ...
      <Route
        path="/ai-teacher"
        element={protect(<AITeacherSetup />)}
      />

      <Route
        path="/ai-teacher/quiz"
        element={protect(<QuizFlow />)}
      />

      <Route
        path="/ai-teacher/summary"
        element={protect(<QuizSummary />)}
      />

      <Route
        path="/history"
        element={protect(<History />)}
      />

      <Route
        path="/history/:sessionId"
        element={protect(<QuizReplay />)}
      />
